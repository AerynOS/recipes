...
This is done by opening a new tab/shell on the host, navigating to the l/linux-lts dir, and doing a copy operation that looks akin to this:

    cp -v ~/.cache/boulder/build/linux-lts-<version>-<source-release>/x86_64/linux-<version>.tar.xz/.config pkg/config-x86_64
